          ...
          <div class="">
             <div class="page-title">
              ...
              <div class="title_right">
                <div class="col-md-6 col-sm-6   form-group row pull-right top_search">
            ...
            <div class="clearfix"></div>
              <div class="row">
                  ...
                  <div class="x_panel"><h6> Filter by Tags</h6></div>
              </div>
              </div>
                                ...
                                <div class="modal-body">
                                    ...
                                    <form role="form">
                                      <div class="form-group">
                                        <label for="exampleInputEmail1">Add New Customer</label>
                                          <input type="email" class="form-control"
                                          id="newcustomer" placeholder="Enter customer"/>
                                      </div>
                                    </form>
